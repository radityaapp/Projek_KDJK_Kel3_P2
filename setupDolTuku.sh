...
DB_ROOT_PASS='root' # Password default untuk root MySQL
DB_NAME='woocommerce_db'
DB_USER='woo_user'
DB_PASS='PasswordKuat123!' # Ganti dengan password yang lebih aman jika perlu

echo "[INFO] Mengamankan MySQL dan membuat database..."
# Non-interaktif amankan MySQL (opsional, bisa diskip jika sudah aman)
...
sudo systemctl restart php8.1-fpm # Sesuaikan versi PHP jika beda
